...
{   
    ...
    const handleSubmit =async(e)=>{
         ...
         const formData= {username:formvalue.username, email:formvalue.email, status:formvalue.status, password:formvalue.password}; 
         const res= await axios.post("http://localhost/react-project_crude/react-project/api/user.php",formData);
