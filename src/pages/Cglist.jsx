...
{ 
 ...
 const getUserData= async()=>{
    const reqData= await fetch("http://localhost/react-project_crude/react-project/api/user.php");
    const resData= await reqData.json();           
    setUserData(resData);
     } 

 const handleDelete= async(id)=>{
   const res= await axios.delete("http://localhost/react-project_crude/react-project/api/user.php"+id);
